...
<div class="aside">
    ...
    <h5><a href="/address" class="{{ Request::is('address*') ? 'active' : '' }}"><i class="fa fa-fw fa-map-marker"></i>
            Addresses</a></h5>
    <h5><a href="/wishlist" class="{{ Request::is('wishlist*') ? 'active' : '' }}"><i class="fa fa-fw fa-heart"></i>
            Wishlist</a></h5>
...
<div class="aside">
    ...
    <h5><a href="/address" class="{{ Request::is('address*') ? 'active' : '' }}"><i class="fa fa-fw fa-map-marker"></i>
            Alamat Saya</a></h5>
    <h5><a href="/favourites" class="{{ Request::is('favourites*') ? 'active' : '' }}"><i class="fa fa-fw fa-heart"></i>
            Favorit Saya</a></h5>
    <h5><a href="/orders" class="{{ Request::is('orders*') ? 'active' : '' }}"><i class="fa fa-fw fa-file-text-o"></i>
            Pesanan Saya</a></h5>
    <br>
