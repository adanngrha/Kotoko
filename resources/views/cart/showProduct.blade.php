    ...
    <div class="container">
        ...
        <div class="row">
            ...
            @foreach ($products as $pdt)
                @if ($product->category->id == $pdt->category->id)
                <div class="col-md-3 col-xs-6">
                    <div class="product">
                        <div class="product-img">
                            <img src="https://source.unsplash.com/300x300/?{{ $pdt->category->slug }}" alt="">
                            {{-- <div class="product-label">
                                <span class="sale">-30%</span>
                            </div> --}}
                        </div>
                        <div class="product-body">
                            <p class="product-category">{{$pdt->category->name}}</p>
                            <h3 class="product-name"><a href="{{url('show-product/'.$pdt->id)}}">{{$pdt->name}}</a></h3>
                            <h4 class="product-price">Rp{{$pdt->price}}</h4>
                            <div class="product-rating">
                            </div>
